<?php
	...
	FreePBX::Mihuendpoint()->configmod->getConfigModuleSQL(false);
	
	
	if ((FreePBX::Mihuendpoint()->configmod->get("server_type") == 'file') AND (FreePBX::Mihuendpoint()->epm_advanced->epm_advanced_config_loc_is_writable())) {
		FreePBX::Mihuendpoint()->tftp_check();
	}
	
	if (FreePBX::Mihuendpoint()->configmod->get("use_repo") == "1") {
		if (FreePBX::Mihuendpoint()->has_git()) {
			
			if (!file_exists(FreePBX::Mihuendpoint()->PHONE_MODULES_PATH . '/.git')) {
				$o = getcwd();
		...
		if (file_exists(FreePBX::Mihuendpoint()->PHONE_MODULES_PATH . '/.git')) {
			FreePBX::Mihuendpoint()->rmrf(FreePBX::Mihuendpoint()->PHONE_MODULES_PATH);
			$sql = "SELECT * FROM  `mihuendpoint_brand_list` WHERE  `installed` =1";
			$result = & sql($sql, 'getAll', DB_FETCHMODE_ASSOC);
			foreach ($result as $row) {
				FreePBX::Mihuendpoint()->remove_brand($row['id'], FALSE, TRUE);
			}
		}
	}
?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
      							<input type="text" class="form-control" placeholder="Server PBX..." id="srvip" name="srvip" value="<?php echo FreePBX::Mihuendpoint()->configmod->get("srvip"); ?>">
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="config_loc" name="config_loc" value="<?php echo FreePBX::Mihuendpoint()->configmod->get("config_location"); ?>">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
                        	<div class="input-group input-group-br">
								...
								<?php
									$list_tz = FreePBX::Mihuendpoint()->listTZ(FreePBX::Mihuendpoint()->configmod->get("tz"));
								...
								<span class="input-group-btn">
									<button class="btn btn-default" type="button" id='tzphp' onclick="epm_advanced_tab_setting_input_value_change_bt('#tz', sValue = '<?php echo FreePBX::Mihuendpoint()->config->get('PHPTIMEZONE'); ?>', bSaveChange = true);"><i class="fa fa-clock-o"></i> <?php echo _("TimeZone PBX")?></button>
								</span>
							</div>
						</div>
					</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
      							<input type="text" class="form-control" placeholder="Server NTP..." id="ntp_server" name="ntp_server" value="<?php echo FreePBX::Mihuendpoint()->configmod->get("ntp"); ?>">
      							<span class="input-group-btn">
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="nmap_loc" name="nmap_loc" value="<?php echo FreePBX::Mihuendpoint()->configmod->get("nmap_location"); ?>">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="arp_loc" name="arp_loc" value="<?php echo FreePBX::Mihuendpoint()->configmod->get("arp_location"); ?>">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" class="form-control" id="asterisk_loc" name="asterisk_loc" value="<?php echo FreePBX::Mihuendpoint()->configmod->get("asterisk_location"); ?>">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
      							<input type="text" class="form-control" placeholder="Server Packages..." id="package_server" name="package_server" value="<?php echo FreePBX::Mihuendpoint()->configmod->get("update_server"); ?>">
      							<span class="input-group-btn">
...
<div class="section" data-id="setting_experimental">
	...
	<?php $ari_selected = FreePBX::Mihuendpoint()->configmod->get("enable_ari"); ?>
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
	...
	<!--Enable Debug Mode-->
	<?php 
		$debug_selected = FreePBX::Mihuendpoint()->configmod->get("debug");
		if ($debug_selected) {
			//global $debug;
	...
	<!--Disable Tooltips-->
	<?php $help_selected = FreePBX::Mihuendpoint()->configmod->get("disable_help"); ?>
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
	...
	<?php $dupext_selected = FreePBX::Mihuendpoint()->configmod->get("show_all_registrations"); ?>
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
	...
	<?php $allow_hdfiles = FreePBX::Mihuendpoint()->configmod->get("allow_hdfiles"); ?>
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
	...
	<?php $tftp_checked = FreePBX::Mihuendpoint()->configmod->get("tftp_check"); ?>
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
	...
	<?php $backup_checked = FreePBX::Mihuendpoint()->configmod->get("backup_check"); ?>
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
	...
	<?php $use_repo = FreePBX::Mihuendpoint()->configmod->get("use_repo"); ?>
	<div class="element-container">
		<div class="row">
			<div class="col-md-12">
				<div class="row">
	...
	<!--GIT Branch-->
	<?php
	if (FreePBX::Mihuendpoint()->configmod->get("use_repo")) {
