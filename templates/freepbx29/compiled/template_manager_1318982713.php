...
?>
  <tr>
	...
	<td align='center' width='9%'><a href="config.php?type=tool&amp;edit_template=true&amp;display=epm_templates&amp;custom=<?php echo $value1["custom"];?>&amp;id=<?php echo $value1["id"];?>"><img src='assets/endpointman/images/edit.png' ALT='<?php echo _('Edit')?>' border='0'></a></td>
	<td align='center' width='5%'><?php
			if( $value1["custom"] == 0 ){
?>
	<a href="config.php?type=tool&amp;delete_template=true&amp;display=epm_templates&amp;id=<?php echo $value1["id"];?>"><img src='assets/endpointman/images/delete.png' ALT='<?php echo _('Delete')?>' border='0'></a><?php
			}
?></td>
  </tr>
<?php
