...
?>
	...
	<?php
		if( $var["mode"] == 'EDIT' ){
?>
        <input type='Submit' name='button_save' onclick="submit_wtype_sub('edit',<?php echo $var["edit_id"];?>,'button_save');" value='<?php echo _('Save')?>'>
	<?php
		}
		else{
?>
...
?>
    ...
    <td align='center'><?php
		if( $var["mode"] != 'EDIT' ){
?><input type='reset' value='<?php echo _('Reset')?>'><?php
		}
?></td>
</tr>
<?php
...
?>
        <tr class="headerRow">
            <td align='center' width="5%"><div id="demo"><img src="assets/endpointman/images/circle_<?php
...
?>.png" alt="<?php echo $value1["status"]["ip"];?>:<?php echo $value1["status"]["port"];?>"><input type="checkbox" name="selected[]" value="<?php echo $value1["id"];?>"></div></td>
            ...
            <td width="10%" align='center'><div id="demo"><a><img src="assets/endpointman/images/expand.png" id="img2rowGroup<?php echo $value1["master_id"];?>" onclick="toggleDisplay(document.getElementById('devList'),'rowGroup<?php echo $value1["master_id"];?>')" title="Click to Expand Line Information"></a></div></td>
            <td width="19%" align='center'><div id="demo"><a><img src="assets/endpointman/images/expand.png" id="img3rowGroup<?php echo $value1["master_id"];?>" onclick="toggleDisplay(document.getElementById('devList'),'rowGroup<?php echo $value1["master_id"];?>')" title="Click to Expand Line Information"></a></div></td>
            <td align='center' width='15%'><?php echo $value1["template_name"];?></td>
            <!--<td align='center'><div id="demo"><a href="#" onclick="submit_stype('edit',<?php echo $value1["id"];?>);"><img src='assets/endpointman/images/edit.png' ALT='<?php echo _('Edit')?>' title='Edit Device' border='0'></a></div></td>-->
            <td align='center' width='9%'><div id="demo"><a href="#" onclick="submit_wtype('edit',<?php echo $value1["id"];?>);"><img src='assets/endpointman/images/edit.png' ALT='<?php echo _('Edit')?>' title='Edit Device' border='0'></a></div></td>
            <td align='center' width='7%'><div id="demo"><a href="#" onclick="delete_device(<?php echo $value1["id"];?>);"><img src='assets/endpointman/images/delete.png' ALT='<?php echo _('Delete')?>' title='Delete Device' border='0'></a></div></td>
        </tr>
        <?php
...
?>
        <tr class="rowGroup<?php echo $value2["master_id"];?> toggle_all" id="<?php echo $value2["master_id"];?>" style="display:none;">
            ...
            <td></td>
            <td align='center' width='7%'><div id="demo"><a href="#" onclick="submit_wtype('delete_line',<?php echo $value2["luid"];?>);"><img src='assets/endpointman/images/delete.png' ALT='<?php echo _('Delete')?>' title='Delete Line' border='0'></a></div></td>
        </tr>
        <?php
				$counter2++;
			}
...
<table width='90%' align='center'>
    <tr>
        ...
        <td width="26%" align='center'><input type="submit" name="button_rebuild_selected" onclick="submit_managed('rebuild_selected_phones');" value="<?php echo _('Rebuild Configs for Selected Phones')?>"><br /><input type="checkbox" name="reboot">Reboot Phones</td>
...
?>
            </select> <?php echo _('Model')?>: <select name="model_list_selected" id="model_list_selected"><option></option></select><br /><input type="submit" name="button_update_phones" onclick="submit_managed('change_brand');" value="<?php echo _('Update Phones')?>"><br /><input type="checkbox" name="reboot_change">Reboot Phones</td>
    </tr>
</table>
</form>
<hr>
